...
Esta app ofrece una herramienta visual sencilla para facilitar la comprensión de como se relacionan ciertas características del vino y su calidad final. La aplicación incluye:

-Un histograma de calidad según las puntuaciones asignadas del dataset.

-Un gráfico de dispersión en donde se relacionan los grados de alcohol y la puntuación de calidad. En general, nos muestra que los vinos con mayor graduación alcohólica tienden a recibir mejor puntuación.
...
Vease también en Render: https://proyecto-sprint-7-zjot.onrender.com
